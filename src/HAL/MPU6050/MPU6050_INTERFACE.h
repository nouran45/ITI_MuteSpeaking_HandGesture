...
// External I2C mux selector function pointer
...
typedef struct {
    ...
    s16 s16AxOff, s16AyOff, s16AzOff;  // accelerometer offset (raw LSB)
    s16 s16GxOff, s16GyOff, s16GzOff;  // gyroscope offset (raw LSB)
} MPU6050_Dev_t;
